...
import { Figure, Image, NavLink, ListGroup, Tab } from 'react-bootstrap';
                                        ...
                                        <div class="container">
                                            <div class="row row-cols-1 row-cols-md-2 g-4">
                                                <div className="col-md-6" style={{ 'border': '1px solid red' }}>
                                                    <div class="veg-indian pt-2">
                                                        <img src="img/veg.png" alt="..." style={{ 'height': '15px', 'width': '15px', 'float': 'right' }} />
                                                    </div>
                                                    <div>
                                                        <Figure.Image alt='Invalid' src="../../img/onion.jpg" />
                                                    </div>
                                                    <div className="col-4" style={{ 'border': '1px solid black' }}>
                                                        <div class="x8c8t">
                                                            <div class="_1lzMu" style={{ 'justify-content': 'center' }}>
                                                                <div id="thumb_0" class="_19N6A rippleEffect" style={{ 'border': '1px solid rgb(132, 194, 37)' }}><img class="_3oKVV " src="https://www.bigbasket.com/media/uploads/p/s/40183658_4-hit-cockroach-killer-spray.jpg" alt="" style={{ 'opacity': '1', 'width': 'initial', 'height': 'initial' }} /></div>
                                                                <div id="thumb_1" class="_19N6A rippleEffect" style={{ 'border': '1px solid rgb(238, 238, 238)' }}><img class="_3oKVV " src="https://www.bigbasket.com/media/uploads/p/s/40183658-2_6-hit-cockroach-killer-spray.jpg" alt="" style={{ 'opacity': '1', 'width': 'initial', 'height': 'initial' }} /></div>
                                                                <div id="thumb_2" class="_19N6A rippleEffect" style={{ 'border': '1px solid rgb(238, 238, 238)' }}><img class="_3oKVV " src="https://www.bigbasket.com/media/uploads/p/s/40183658-3_6-hit-cockroach-killer-spray.jpg" alt="" style={{ 'opacity': '1', 'width': 'initial', 'height': 'initial' }} /></div>
                                                                <div id="thumb_3" class="_19N6A rippleEffect" style={{ 'border': '1px solid rgb(238, 238, 238)' }}><img class="_3oKVV " src="https://www.bigbasket.com/media/uploads/p/s/40183658-4_6-hit-cockroach-killer-spray.jpg" alt="" style={{ 'opacity': '1', 'width': 'initial', 'height': 'initial' }} /></div>
                                                                <div id="thumb_4" class="_19N6A rippleEffect" style={{ 'border': '1px solid rgb(238, 238, 238)' }}><img class="_3oKVV " src="https://www.bigbasket.com/media/uploads/p/s/40183658-5_6-hit-cockroach-killer-spray.jpg" alt="" style={{ 'opacity': '1', 'width': 'initial', 'height': 'initial' }} /></div>
                                                                <div id="thumb_5" class="_19N6A rippleEffect" style={{ 'border': '1px solid rgb(238, 238, 238)' }}><img class="_3oKVV " src="https://www.bigbasket.com/media/uploads/p/s/40183658-6_6-hit-cockroach-killer-spray.jpg" alt="" style={{ 'opacity': '1', 'width': 'initial', 'height': 'initial' }} /></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="col-md-6" style={{ 'border': '1px solid green' }}>
                                                    <div className="d-flex justify-content-start pl-2">
                                                        <Link to="/" alt=".." style={{ 'font-size': '0.8rem', 'color': 'black' }}>
                                                            Fresho
                                                        </Link>
                                                    </div>
                                                    <div className="d-flex justify-content-start pl-2">
                                                    ...
                                                    <div className="col-md-12" style={{ 'border': '1px solid yellow' }}>
                                                        <div className="price mt-2">
                                                            <span className="mrp ml-2">MRP <s style={{ 'font-size': '11px' }}>Rs. 31.25</s><span>&nbsp;Price: Rs.19</span></span><br />
                                                            ...
                                                            <div className="row">
                                                                <div class="col-md-6 p-1" style={{}}>
                                                                    <div>
                                                                        <button type="button" className="b2n _2KpZ62 _2KpZ6l" data-toggle="button" style={{}}>
                                                                            <span style={{}}><img src="https://img.icons8.com/material-outlined/24/000000/fast-cart.png" alt="" />add to cart</span>
                                                                        </button>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6 p-1" style={{}}>
                                                                    <div>
                                                                        <button type="button" className="b2nn _2KpZ62 _2KpZ6l" data-toggle="button" style={{}}>
                                                    ...
                                                    <div className="col">
                                                        <span className="fontawesome p-2"><FontAwesomeIcon icon={faTruck} /></span>
                                                        <span>Standard: Please collect token before ordering</span>
                                                    </div>
                                                    <Tab.Container id="list-group-tabs-example" defaultActiveKey="#link1">
                                                        <div className="row">
                                                            <div className="col-md-12">
                                                                <section class="irDHq">
                                                                    <div class="_2WW4W"><span>Pack Sizes</span></div>
                                                                    <div class="_1LiCn">
                                                                        <ListGroup>
                                                                            <ListGroup.Item action variant="light" style={{ 'border': '0px' }}>
                                                                                <div class="_2Z6Vt h7E8k rippleEffect">
                                                                                    <div class="_34ICY">
                                                                                        <div class="_3Yybm"> 700 ml</div>
                                                                                        <div class="_30D1l"></div>
                                                                                    </div>
                                                                                    <div class="_1K6b_">
                                                                                        <div>
                                                                                            <span class="_2j_7u">Rs 275</span>
                                                                                            <span class="Vc7dk">
                                                                                                MRP:
                                                                            <span class="tQ1Iy">
                                                                                                    Rs 325
                                                                            ...
                                                                            <ListGroup.Item action variant="light" style={{ 'border': '0px' }}>
                                                                                <div class="_2Z6Vt h7E8k rippleEffect">
                                                                                    <div class="_34ICY">
                                                                                        <div class="_3Yybm"> 200 ml</div>
                                                                                        <div class="_30D1l"></div>
                                                                                    </div>
                                                                                    <div class="_1K6b_">
                                                                                        <div>
                                                                                            <span class="_2j_7u">Rs 98.98</span>
                                                                                            <span class="Vc7dk">
                                                                                                MRP:
                                                                            <span class="tQ1Iy">
                                                                                                    Rs 101
                                                                                            ...
                                                                                            <span class="_1lWqh">SAVE Rs 2</span>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="_1DBJl"></div>
                                                                                </div>
                                                                            ...
                                                                            <ListGroup.Item action variant="light" style={{ 'border': '0px' }}>
                                                                                <div class="_2Z6Vt h7E8k rippleEffect">
                                                                                    <div class="_34ICY">
                                                                                        <div class="_3Yybm"> 400 ml</div>
                                                                                        <div class="_30D1l"></div>
                                                                                    </div>
                                                                                    <div class="_1K6b_">
                                                                                        <div>
                                                                                            <span class="_2j_7u">Rs 210.49</span>
                                                                                            <span class="Vc7dk">
                                                                                                MRP:
                                                                            <span class="tQ1Iy">
                                                                                                    Rs 217
                                                                                            ...
                                                                                            <span class="_1lWqh">SAVE Rs 7</span>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="_1DBJl"></div>
                                                                                </div>
